 ...
 * @author Lia
 */
public class BotoesLivroView extends javax.swing.JPanel {

    /**
     * Creates new form BotoesAutorView
     */
    public BotoesLivroView() {
        initComponents();
    }
    ...
    void setController(LivroController controller) {
        this.btnCriar.addActionListener(e -> controller.criarLivro());
        this.btnAtualizar.addActionListener(e -> controller.atualizarLivro());
        this.btnExcluir.addActionListener(e -> controller.excluirLivro());
        this.btnListar.addActionListener(e -> controller.listarLivro());
    }
}
