...
public class BuscaClienteView extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        buscarLabel.setText("Buscar conta por");

        tipoComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CPF" }));
    ...
    void setController(ContaController controller) {
        this.btnBuscar.addActionListener(e -> controller.buscarConta(tipoComboBox.getSelectedIndex()));
    }
